    ...
    return (
        <div className="h-full w-full justify-center items-center group
            ...
            <div className="relative w-full h-full">
                ...
                <iframe className="w-full h-full py-3" src={`https://www.youtube.com/embed/${youtubeVideoId}?si=XPwgI3fm_8qHyHzp&vq=hd720`} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
